...
const STEPS = [
  ...
  },
  {
    id: "defend",
    num: "04",
    label: "Learn How To Prevent It",
    title: "4. Learn How To Prevent It",
      ...
      >
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="mt-4 text-slate-400 text-sm md:text-base leading-relaxed font-sans">
            Learn cybersecurity through a simple four-step journey. Build a scenario, watch the attack unfold, understand what happened, and discover how it could have been prevented.
          </p>
        </div>
                    ...
                    <div className="bg-black/85 rounded-lg border border-cyber-border overflow-hidden min-h-[300px] flex flex-col justify-between">
                      ...
                      <div className="bg-cyber-surface px-4 py-2 border-b border-cyber-border flex items-center justify-between text-[10px] font-mono text-slate-400">
                        <span className="flex items-center gap-1.5 uppercase">
                          ...
                          {step.id === "generate" ? "Scenario Preview" : "System State Simulator"}
                        </span>
                        <span>{step.id === "generate" ? "Lab Config" : "v1.0.4"}</span>
                      </div>
                        ...
                        {step.id === "generate" && (
                          <div className="space-y-4 font-sans text-xs w-full">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                              {/* Attack Type */}
                              <div className="p-3.5 rounded bg-cyber-surface/50 border border-cyber-border hover:border-cyber-cyan/35 transition-all duration-300">
                                ...
                                <p className="text-[10px] text-slate-450 mt-1 leading-relaxed">
                                  Trick users with tailored emails to run software and harvest credentials.
                                </p>
                              </div>
                              ...
                              <div className="p-3.5 rounded bg-cyber-surface/50 border border-cyber-border hover:border-cyber-cyan/35 transition-all duration-300">
                                ...
                                <div className="text-white font-bold text-xs flex items-center gap-2">
                                  ...
                                  Hospital EMR Network
                                </div>
                                <p className="text-[10px] text-slate-455 mt-1 leading-relaxed">
                                  Access servers holding patient records and clinical databases.
                                </p>
                              </div>
                              ...
                              <div className="p-3.5 rounded bg-cyber-surface/50 border border-cyber-border hover:border-cyber-cyan/35 transition-all duration-300">
                                ...
                                <div className="text-white font-bold text-xs flex items-center gap-2">
                                  <span className="text-cyber-green text-sm">🛡️</span>
                                  Standard Endpoint Defense
                                </div>
                                <p className="text-[10px] text-slate-450 mt-1 leading-relaxed">
                                  Signature-based antiviruses, basic email filtering, and firewalls.
                                </p>
                              </div>
                              ...
                              <div className="p-3.5 rounded bg-cyber-surface/50 border border-cyber-border hover:border-cyber-cyan/35 transition-all duration-300">
                                ...
                                <div className="text-white font-bold text-xs flex items-center gap-2">
                                  ...
                                  Analyze Mitigation Steps
                                </div>
                                <p className="text-[10px] text-slate-450 mt-1 leading-relaxed">
                                  Learn how to identify and deploy email rules and endpoint privilege policies.
                                </p>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="flex items-center gap-10 z-10">
                              ...
                              <div className="flex flex-col gap-6 relative">
                                ...
                                <div className="w-10 h-10 rounded border border-slate-800 bg-slate-950 flex items-center justify-center relative">
                                  <span className="absolute -top-6 text-[8px] text-slate-650 font-mono">DB_01</span>
                      ...
                      <div className="bg-cyber-surface/50 border-t border-cyber-border px-4 py-2 text-[9px] text-slate-500 font-mono flex justify-between">
                        <div>{step.id === "generate" ? "MODE: EDUCATIONAL LAB" : "MODE: STANDALONE RUNNER"}</div>
                        <div className="text-slate-400">{step.id === "generate" ? "READY_TO_START" : "SECURITY_LOG_OK"}</div>
                      </div>
                    </div>
                  </div>
                </motion.div>
